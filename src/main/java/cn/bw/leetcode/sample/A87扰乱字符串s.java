...
public class A87扰乱字符串s {
    ...
    public boolean isScramble4(String s1, String s2) {
        ...
        for(int i=1;i<s1.length();i++){
            if(isScramble4(s1.substring(0,i), s2.substring(0,i))&&
                    isScramble4(s1.substring(i),s2.substring(i))){
                return true;
            }

            if(isScramble4(s1.substring(i), s2.substring(0,s2.length()-i))
                    && isScramble4(s1.substring(0,i),s2.substring(s2.length()-i))){
                return true;
            }
        }
